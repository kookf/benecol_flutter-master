...
class OatProductDetailModal extends StatefulWidget {
  int productId;

  OatProductDetailModal({ 
    Key? key,
    required this.productId
  }) : super(key: key);

  @override
  _OatProductDetailModalState createState() => _OatProductDetailModalState();
}

class _OatProductDetailModalState extends State<OatProductDetailModal> {
  ...
  Future<void> getProductDetail(BuildContext context) async {
    ...
    await context.read<AboutOatProvider>().getOatProductDetail(context, _currentId.toString(), widget.productId);
  }
  
  @override
  Widget build(BuildContext context) {
    T = AppLocalizations.of(context)!;
    _productDetail = context.watch<AboutOatProvider>().productDetail;
